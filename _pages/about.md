...
<!-- <div class="row  align-items-center">
    <div class="col-sm-2 mt-6 mt-md-0">
        <img class="img-fluid " src="{{ '/assets/img/affiliations/TUM.png' | relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-2 mt-6 mt-md-0">
        <img class="img-fluid" src="{{ '/assets/img/affiliations/ETH.png' | relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-2 mt-6 mt-md-0">
        <img class="img-fluid" src="{{ '/assets/img/affiliations/UD.png' | relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-2 mt-6 mt-md-0">
        <img class="img-fluid" src="{{ '/assets/img/affiliations/UTS.png' | relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-2 mt-6 mt-md-0">
        <img class="img-fluid" src="{{ '/assets/img/affiliations/ZJU.png' | relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-2 mt-6 mt-md-0">
        <img class="img-fluid" src="{{ '/assets/img/affiliations/UESTC.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
...
My research interests include perception, 3D computer vision, probabilistic multi-sensor fusion, visual-inertial navigation, state estimation, and dense mapping.  
